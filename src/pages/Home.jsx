        ...
        <div>
          <main className="max-w-6xl mx-auto">
            <h1 className="text-4xl font-bold mb-4 text-center text-gray-700 dark:text-gray-100">
              Selamat Datang di Perpustakaan Gedangan
            </h1>
            ...
            <section className="bg-gray-200 dark:bg-gray-800 rounded-xl shadow p-6 space-y-4">
              <p>
                Perpustakaan Gedangan menyediakan berbagai koleksi buku bacaan untuk masyarakat
                umum, mulai dari fiksi, non-fiksi, buku anak, hingga literatur akademik. Kami
                berkomitmen untuk mendukung minat baca dan literasi di lingkungan sekitar.
              </p>
              <p>
                Anda dapat melakukan pencatatan dan pengelolaan data koleksi buku pada halaman Books.
              </p>
            </section>
          </main>
        </div>
