...
useEffect(() => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!success) return setError("Username atau password salah");
    navigate("/");
  };

  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 flex-col">
      <h1 className="text-4xl font-bold text-center text-gray-900 dark:text-white font-light mb-8">Perpustakaan<br /><b className='font-bold'>Gedangan</b></h1>
